...
\begin{enumerate}
  ...
  \item line 14: \texttt{null?} returns true if its parameter is the empty list
  \item line 16: \texttt{cadr} is a composition of \texttt{cdr} and \texttt{car} 
    \begin{equation*}
      \texttt{(cadr alist)} \Rightarrow \texttt{(car (cdr list))}
    \end{equation*}
  \item line 18: \texttt{eval} evaluates the given list in the same manner as the 
  ...
  \item line 22: \texttt{cddr} is a composition of \texttt{cdr} with itself
    \begin{equation*}
